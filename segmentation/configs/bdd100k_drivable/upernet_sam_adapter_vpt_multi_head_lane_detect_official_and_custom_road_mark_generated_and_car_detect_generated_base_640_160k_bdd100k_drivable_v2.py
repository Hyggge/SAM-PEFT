...
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/bdd100k_drivable_multi_head_lane_detect_official_and_custom_road_mark_generated_and_car_detect_generated.py',
