...
model = dict(
    ...
    decode_head=dict(
        ...
        norm_cfg=norm_cfg,
        align_corners=False,
        loss_decode=dict(type='FocalLoss', use_sigmoid=True, loss_weight=1.0, class_weight=[1.0, 5.0])
    ),
    auxiliary_head=dict(
            type='FCNHead',
            in_channels=768,
            ...
            norm_cfg=norm_cfg,
            align_corners=False,
            loss_decode=dict(type='FocalLoss', use_sigmoid=True, loss_weight=0.4, class_weight=[1.0, 5.0])
        ),
