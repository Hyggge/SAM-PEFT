...
train_pipeline = [
    ...
    dict(type='LoadLaneDetectGT', aux_gt_dirs=['data/bdd100k/labels/lane/generated_masks/train'], suffixs=['.png']),
...
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadLaneDetectGT', aux_gt_dirs=['data/bdd100k/labels/lane/generated_masks/val'], suffixs=['.png']),
    dict(
