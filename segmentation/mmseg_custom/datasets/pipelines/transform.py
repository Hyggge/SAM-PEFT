...
class NormalizeCustom(object):
    ...
    def __init__(self, field_name, mean, std, to_rgb=True):
    ...
    def __call__(self, results):
        ...
        results[self.field_name] = mmcv.imnormalize(results[self.field_name], self.mean, self.std,
                                          self.to_rgb)
        results[f'{self.field_name}_cfg'] = dict(
